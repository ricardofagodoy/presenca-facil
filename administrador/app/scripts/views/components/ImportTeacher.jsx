...
export default class ImportTeacher extends React.Component {
  ...
  handleImport() {
    ImportService.import(this.state.file, TeacherService.teacherMapper, TeacherService.importTeachers)
      .then(() => {
          ...
          <div className="search-form" id="search-form">
            ...
            <div className="form-group">
              <div className="col-sm-8">
                <h4>Instruções:</h4>
                Escolha um arquivo de extensão <b>.CSV</b> contendo os professores que se deseja importar.
                <br />
                A separação dos campos de cada professor será usando <b>;</b> e cada professor ficará em um linha.
                <br />
                <br />
                O conteúdo do arquivo deve estar no seguinte estilo para cada professor:
                <br />
